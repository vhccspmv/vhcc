...
void convert(int num_threads, int threads_per_core, int num_panel, int rlength, int clength);
...
template<typename IndexType, typename ValueType>
void vhcc_matrix<IndexType, ValueType>
	::convert(int num_threads, int threads_per_core, int num_panels, int rlength, int clength)
{
